  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
      {facultyMembers.map((member) => (
        <Card
          key={member.id}
          className="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden h-full flex flex-col 
        ...
        >
          ...
          <div className="relative overflow-hidden flex-shrink-0">
            ...
            {/* Experience Badge */}
            <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white 
                            text-xs font-bold px-3 py-2 rounded-full shadow-lg backdrop-blur-sm border border-white/20
          ...
          <CardContent className="p-5 flex flex-col flex-grow bg-gradient-to-b from-white to-gray-50/50">
            <div className="mb-4 flex-grow text-center">
              ...
              <h3
                className="text-xl font-bold text-gray-900 mb-3 leading-tight h-12 flex items-center justify-center
            ...
            <div className="mt-auto">
              <Link href={`/faculty/${member.slug}`} data-testid={`link-faculty-profile-${member.id}`}>
                <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm py-3 rounded-lg
                                   transition-all duration-300 font-semibold shadow-lg border border-blue-500/20
                                   hover:shadow-xl hover:-translate-y-1 hover:from-blue-700 hover:to-blue-800">
